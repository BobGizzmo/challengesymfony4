 ...
 */
final class Version20191009090310 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__house AS SELECT id, city_id, nomination, image, price FROM house');
        ...
        $this->addSql('INSERT INTO house (id, city_id, nomination, image, price) SELECT id, city_id, nomination, image, price FROM __temp__house');
